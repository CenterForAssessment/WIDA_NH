...
WIDA_NH_Data_LONG_2022[,ACHIEVEMENT_LEVEL_ORIGINAL:=paste0(ACHIEVEMENT_LEVEL_ORIGINAL, ".0")]
WIDA_NH_Data_LONG_2022[,ACHIEVEMENT_LEVEL_ORIGINAL:=strhead(ACHIEVEMENT_LEVEL_ORIGINAL, 3)]
